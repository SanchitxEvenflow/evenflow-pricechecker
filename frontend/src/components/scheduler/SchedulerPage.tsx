...
export function SchedulerPage({ t, dark }: { t: ThemeClasses; dark: boolean }) {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-8 space-y-8">
      ...
      <ManualTriggerCard t={t} dark={dark} brand="amazon" status={scheduler.cronStatus} isTriggering={scheduler.isTriggering} onTrigger={scheduler.handleTrigger} onCancel={scheduler.handleCancel} isCancelling={scheduler.isCancelling} />
      <ManualTriggerCard t={t} dark={dark} brand="blinkit" status={scheduler.blinkitStatus} isTriggering={scheduler.isBlinkitTriggering} onTrigger={scheduler.handleBlinkitTrigger} onCancel={scheduler.handleBlinkitCancel} isCancelling={scheduler.isBlinkitCancelling} />
