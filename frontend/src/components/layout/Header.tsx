    ...
    <header className="sticky top-0 z-20 border-b border-neutral-800 bg-neutral-950 text-neutral-100">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#/flipkart-minutes" className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${page === "flipkart_minutes" ? "bg-[#2874F0] text-white" : "bg-neutral-800 hover:bg-neutral-700 text-white"}`}>
            FK Minutes
          </a>
          ...
          {AUTH_ENABLED && (
            <button
              ...
              className="px-3 py-2 rounded-xl text-sm font-medium bg-red-950 hover:bg-red-900 text-red-300 border border-red-800 transition-all"
            >
              Log out
            </button>
          )}
