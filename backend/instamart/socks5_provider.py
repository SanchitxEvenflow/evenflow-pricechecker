...
SOCKS5 proxy provider for Swiggy Instamart scraping via Snowpad.
...
class Socks5Provider:
    """
    Provides SOCKS5 proxy strings/dicts for Instamart scrapers.
    ...
    async def bridge_proxy(self) -> dict | None:
        ...
        (instamart/socks5_bridge.py) on first use and hands back a no-auth
